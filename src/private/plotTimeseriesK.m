function hdiag = plotTimeseriesK(hdiag,n,jdiag,kspec,prm,ren)
%plotTimeseriesK Time series k-spectrum plot (Ex,Ey,Ez,By,Bz)
%
%

ifdiag = prm.ifdiag; ntime = prm.ntime; dt = prm.dt; nx = prm.nx;
